...
public class Aam4Layer extends GeoRenderLayer<Aam4Entity> {
    private static final ResourceLocation LAYER = new ResourceLocation("superbwarfare", "textures/entity/rpg_rocket_e.png");

    public Aam4Layer(GeoRenderer<Aam4Entity> entityRenderer) {
        super(entityRenderer);
    }

    public void render(PoseStack poseStack, Aam4Entity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
