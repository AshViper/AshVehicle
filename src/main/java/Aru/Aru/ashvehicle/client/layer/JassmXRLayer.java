...
public class JassmXRLayer extends GeoRenderLayer<JassmXREntity> {
    private static final ResourceLocation LAYER = new ResourceLocation("superbwarfare", "textures/entity/rpg_rocket_e.png");

    public JassmXRLayer(GeoRenderer<JassmXREntity> entityRenderer) {
        super(entityRenderer);
    }

    public void render(PoseStack poseStack, JassmXREntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
