...
public class UH60Entity extends ContainerMobileVehicleEntity implements GeoEntity, HelicopterEntity, WeaponVehicleEntity {
    ...
    public void positionRider(@NotNull Entity passenger, @NotNull Entity.@NotNull MoveFunction callback) {
        if (this.hasPassenger(passenger)) {
            ...
            if (i == 0) {
                ...
                Vector4f worldPosition = this.transformPosition(transform, -1.1F, 0.4F, -1.4F);
                passenger.setPos((double)worldPosition.x, (double)worldPosition.y, (double)worldPosition.z);
                callback.accept(passenger, (double)worldPosition.x, (double)worldPosition.y, (double)worldPosition.z);
            } else if (i == 3) {
                Vector4f worldPosition = this.transformPosition(transform, 1.1F, 0.4F, -1.4F);
                ...
                Vector4f worldPosition = this.transformPosition(transform, -1.1F, 0.4F, -1.9F);
                passenger.setPos((double)worldPosition.x, (double)worldPosition.y, (double)worldPosition.z);
                callback.accept(passenger, (double)worldPosition.x, (double)worldPosition.y, (double)worldPosition.z);
            }
            else if (i == 5) {
    ...
    static {
        PROPELLER_ROT = SynchedEntityData.defineId(Ah6Entity.class, EntityDataSerializers.FLOAT);
    }
