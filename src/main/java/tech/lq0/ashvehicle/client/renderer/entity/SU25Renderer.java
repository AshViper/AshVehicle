...
import tech.lq0.ashvehicle.client.model.SU25Model;
...
public class SU25Renderer extends GeoEntityRenderer<SU25Entity> {
    ...
    public void preRender(PoseStack poseStack, SU25Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        float scale = 2.0F;
    ...
    public void render(SU25Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
