...
import tech.lq0.ashvehicle.client.layer.GBU57Layer;
import tech.lq0.ashvehicle.client.model.waepon.Aam4Model;
import tech.lq0.ashvehicle.client.model.waepon.GBU57Model;
...
public class GBU57Renderer extends GeoEntityRenderer<GBU57Entity> {
    public GBU57Renderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new GBU57Layer(this));
    }
    ...
    public void preRender(PoseStack poseStack, GBU57Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        float scale = 2.0F;
    ...
    public void render(GBU57Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
