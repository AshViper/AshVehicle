...
import Aru.Aru.ashvehicle.client.model.Mig15Model;
import Aru.Aru.ashvehicle.entity.Mig15Entity;
...
public class Mig15Renderer extends GeoEntityRenderer<Mig15Entity> {
    ...
    public void preRender(PoseStack poseStack, Mig15Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        float scale = 3.0F;
