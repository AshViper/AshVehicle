    ...
    public VehicleModel.TransformContext<F117Entity> collectTransform(String boneName) {
        ...
        switch (boneName){
            ...
            case "RightTailPlane", "LeftTailPlane":
                var1000 = (bone, vehicle, state) -> bone.setRotY(Mth.clamp(Mth.lerp(state.getPartialTick(), vehicle.getFlap3RotO(), vehicle.getFlap3Rot()), -10.0F, 10.0F) * ((float)Math.PI / 180F));
                break;
            default :
                var1000 = null;
                break;
