...
import Aru.Aru.ashvehicle.client.model.Mig29Model;
import Aru.Aru.ashvehicle.entity.Mig29Entity;

public class Mig29Renderer extends GeoEntityRenderer<Mig29Entity> {
    public Mig29Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new Mig29Model());
        this.shadowRadius = 0.0f;
    }
    public RenderType getRenderType(Mig29Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(this.getTextureLocation(animatable));
    }

    public void preRender(PoseStack poseStack, Mig29Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        float scale = 1.0F;
    ...
    public void render(Mig29Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    public void renderRecursively(PoseStack poseStack, Mig29Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
