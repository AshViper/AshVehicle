...
**Founder** — Aru-san (あーる) [@AshViper](https://github.com/AshViper)

**Admin** — DreMch

**Coder** — Denys Shatin [@denys-shatin](https://github.com/denys-shatin)
...
このMODは **Superb Warfare** に航空機などの軍用車両を追加する **アドオンMOD** です。
